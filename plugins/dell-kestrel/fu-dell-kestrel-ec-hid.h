...
#define DELL_KESTREL_EC_HID_TIMEOUT	    2000
#define DELL_KESTREL_EC_HID_CMD_FWUPDATE    0xAB
#define DELL_KESTREL_EC_HID_EXT_FWUPDATE    0x80
#define DELL_KESTREL_EC_HID_SUBCMD_FWUPDATE 0x00
#define DELL_KESTREL_EC_DEV_EC_CHUNK_SZ	    160000
#define DELL_KESTREL_EC_DEV_ANY_CHUNK_SZ    180000
#define DELL_KESTREL_EC_DEV_NO_CHUNK_SZ	    G_MAXSIZE
#define DELL_KESTREL_EC_HID_DATA_PAGE_SZ    192
#define DELL_KESTREL_EC_HID_RESPONSE_LENGTH 0x03
#define DELL_KESTREL_EC_HID_I2C_ADDRESS	    0xec
#define DELL_KESTREL_EC_HID_MAX_RETRIES	    8
